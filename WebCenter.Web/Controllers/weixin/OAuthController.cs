...
{
    public class OAuthController : HomeController
    {



        public OAuthController(IUnitOfWork UOF)
            : base(UOF)
        {
        }     
        ...
        public ActionResult Callback()
        {
            ...
            Common.LogHelper.LogError(string.Format("OAuth success: identity: {0} , name: {1} , redirect_rul:{2} , expires_in: {3}s ", openId, userinfo.nickname, redirect_url, expires_in));
